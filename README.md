...
| 协作平台推送 | 优先写入钉钉知识库完整文档，再推送钉钉 Markdown 摘要卡片；未配置钉钉时可回退飞书摘要 |
| 风险雷达 | 生成“本周美妆法务风险雷达”图片，辅助理解监管主题、市场、风险、业务影响和行动归口 |
| 完整版本 | 钉钉知识库文档是完整周报版本，摘要卡片里的“查看完整版本”链接指向该文档 |
...
完整版本以钉钉知识库文档为准。每次周报生成后，程序会先创建并写入钉钉文档，再把钉钉 Markdown 摘要卡片里的“查看完整版本”链接指向该文档。

未配置钉钉时可回退飞书摘要，但飞书只承载摘要通知，不作为完整周报页面。
...
Worker 会异步运行周报管道，完成后先写入钉钉知识库文档；文档写入成功后推送钉钉 Markdown 摘要卡片。未配置钉钉时回退飞书摘要。
