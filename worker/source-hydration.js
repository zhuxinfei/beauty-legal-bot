...
export function normalizeHydratedRecord(record = {}) {
  ...
  return {
    ...
    discovery_module: text(record.discovery_module || record.module || ''),
    discovery_query: text(record.discovery_query || ''),
    raw_markdown: rawMarkdown,
    fit_markdown: fitMarkdown,
    references_markdown: text(record.references_markdown),
...
export function mergeHydratedCandidates(candidates = [], hydratedRecords = []) {
  ...
  const merged = (Array.isArray(candidates) ? candidates : []).map(candidate => {
    ...
    return {
      ...
      module: record.discovery_module || record.module || candidate.discovery_module || candidate.module,
      discovery_module: record.discovery_module || candidate.discovery_module || record.module || candidate.module,
      discovery_query: record.discovery_query || candidate.discovery_query || '',
