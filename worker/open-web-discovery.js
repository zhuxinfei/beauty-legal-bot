...
const QUERY_GROUPS = Object.freeze({
  '广告合规及处罚案例': [
    ...
    '薇诺娜 OR 珀莱雅 OR 花西子 OR 完美日记 处罚 OR 罚款',
    '化妆品 直播带货 虚假宣传 市监局 罚款 2026',
    '化妆品 广告法 处罚 OR 罚款 site:gov.cn',
  ],
  '知识产权动态': [
    ...
    '化妆品 驰名商标 跨类 保护 判决',
    '护肤品牌 假冒 商标 刑事 判决',
    '珀莱雅 OR 贝泰妮 OR 华熙生物 OR 上海家化 商标 案',
    '欧莱雅 OR 雅诗兰黛 OR 资生堂 OR 爱茉莉 商标 侵权 中国',
    '花西子 OR 完美日记 OR 薇诺娜 OR 自然堂 知识产权',
    '化妆品 商标 无效 宣告 国知局',
    '美妆 品牌 仿冒 山寨 法院 判赔',
    '化妆品 专利 纠纷 原料 配方 判决',
  ],
